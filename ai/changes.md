...
- Fixed table scrolling behavior:
  - Removed drag-and-drop functionality to simplify table implementation
  - Implemented proper horizontal and vertical scrolling
  - Fixed browser navigation interference during horizontal scrolling
  - Added ClampingScrollPhysics to prevent browser back/forward gestures
  - Maintained mapping controls in table headers
  - Improved table performance and responsiveness
